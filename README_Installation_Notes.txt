...
NOTE: As of 4/20/2022 - based on this link: https://www.ti.com/tool/PROCESSOR-SDK-C667X#downloads
...
3. Install CCSv9.3.0 ---> C:\ti\ccs930
...
5. Emulator support files, copy from EVM DVD...
	a. Copy file 'TIXDS2XXUSB_onboard_Connection.xml' 
		to the directory '~\ti\ccs930\ccs_base\common\targetdb\connections'
	b. Copy (replace?) file 'evmc6678l.gel' to (in?) '\ti\ccs930\ccs\ccs_base\emulation\boards\evmc6678l\gel'.
...
6. Install ti_emupack_5.0.838.0 (can be installed 'on top of' CCS baseline release)  --> ~\ti\ccs<version>\ccs_base\
	...
	b. ~\ti\ccs930\ccs\ccs_base is the way it was for CCS930
